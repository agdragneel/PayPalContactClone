...
export function MobileForm() {
  return (
    <div className="container mx-auto px-4 pt-4 pb-8">
      <div className="bg-white shadow-lg rounded-lg max-w-lg mx-auto mb-8">
        <div className="p-8">
          <h2 className="text-2xl font-semibold mb-4">Get Started</h2>
          <p className="mb-4">Tell us a little about your business so we can connect you with the right people.</p>
          <form>
            <div className="mb-4 font-semibold">
              <input type="text" id="firstname" name="firstname" placeholder="First Name*" className="mt-1 p-2 border rounded-md w-full" />
            </div>
